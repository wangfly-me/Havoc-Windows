...
func (b *Builder) Build() bool {
	...
	b.CompileDir = DirPath + "/tmp/" + utils.GenerateID(10) + "/"
	...
	// add sources
	b.sourcePath = strings.Replace(b.sourcePath, "\\", "/", -1)
	for _, dir := range b.compilerOptions.SourceDirs {
		...
		for _, f := range files {
			var FilePath = b.sourcePath + "/" + dir + "/" + f.Name()
	...
	CompileCommand += b.sourcePath + "/" + "/src/Demon.c "

	// add include directories
	for _, dir := range b.compilerOptions.IncludeDirs {
		CompileCommand += "-I" + b.sourcePath + "/" + dir + " "
	}
	...
	case FILETYPE_WINDOWS_EXE:
		...
		CompileCommand += b.sourcePath + "/" + b.compilerOptions.Main.Exe + " "
		break
	...
	case FILETYPE_WINDOWS_SERVICE_EXE:
		...
		CompileCommand += b.sourcePath + "/" + b.compilerOptions.Main.Svc + " "
		break
	...
	case FILETYPE_WINDOWS_DLL:
		...
		CompileCommand += b.sourcePath + "/" + b.compilerOptions.Main.Dll + " "
		break
